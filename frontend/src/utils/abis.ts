...
export const REPUTATION_LEDGER_ABI = [
  ...
  { inputs: [{ internalType: "uint256", name: "offset", type: "uint256" }, { internalType: "uint256", name: "limit", type: "uint256" }], name: "getLeaderboardPage", outputs: [{ internalType: "address[]", name: "addresses", type: "address[]" }, { internalType: "uint256[]", name: "scores", type: "uint256[]" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [{ internalType: "address", name: "volunteer", type: "address" }, { internalType: "uint256", name: "scoreDelta", type: "uint256" }], name: "updateReputation", outputs: [{ internalType: "uint256", name: "newCumulative", type: "uint256" }], stateMutability: "nonpayable", type: "function" },
] as const;

// ── IMPACT_TOKEN_ABI — Kosong (v2.0: GOOD = native coin, bukan ERC-20) ────────
